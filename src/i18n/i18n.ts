...
const pl: Dict = {
  ...
  "cmd.view.typewriterOn": "Włącz tryb maszyny do pisania",
  "cmd.view.typewriterOff": "Wyłącz tryb maszyny do pisania",
  "cmd.view.focusOn": "Włącz tryb skupienia",
  "cmd.view.focusOff": "Wyłącz tryb skupienia",
